...
<title>Maxi Online Store (Business and Technology)</title>
<style type="text/css">
.Teks_Menu_Kiri {
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr valign="top">
              <td width="30%" height="825" bgcolor="#0B78B3"><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#0B78B3">
                ...
                <tr>
                  <td><div align="center"><img src="Gambar/Sub Menu.gif" alt="" width="10" height="10" /></div></td>
                  <td class="Teks_Menu_Kiri"><a href="isi_saran_kritik.php">Mitra Bisnis</a></td>
                </tr>
                <tr>
                  <td><div align="center"><img src="Gambar/Sub Menu.gif" alt="" width="10" height="10" /></div></td>
                ...
                <tr>
                  <td colspan="2"><div align="center"><span class="Teks_Info">Telp : 0711-000000</span></div></td>
                  </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2"><? require("iklan.php") ?></td>
                  </tr>
                <tr>
...
//Perintah ini digunakan untuk menghubungkan ke database dengan membaca file config.php			  
require("config.php");
//fungsi sql yang digunakan untuk mencari dat produk berdasarkan fileter yang diinputkan ke kolom texrfiel cari
$perintah = "SELECT * FROM produk WHERE (nama like '$_POST[cari]%') or (id like '$_POST[cari]%') ORDER BY id DESC";
$hasil = mysql_query($perintah);
//fungsi ini digunakan untuk menampilkan data pencarian 
if (mysql_num_rows($hasil) > 0) {
echo ("<font face=\"arial\" size=\"2\"><center><p>Ditemukan produk yang mengandung kata kunci <b>$cari</b>:</center></font>
<ul>
");
//jika data ditemukan maka akan ditampilkan data tersebut
while($data=mysql_fetch_array($hasil)) {
echo ("
<li><b><a style=\"color: blue\" href=\"detail.php?id=$data[id]\"><font face=\"arial\" size=\"2\">$data[nama]</b></font></a></li>
");
}
echo("</ul>");
} else {
echo("<font face=\"arial\" size=\"2\"><center>Maaf, produk dengan kata kunci <b>$cari</b> tidak ditemukan.</center></font>");
}
//akhir penutup kode php
?></p>
      </p></td>
            </tr>
          </table></td>
