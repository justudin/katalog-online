...
<title>RaChick Cipanas</title></head>
<style type="text/css">
.Teks_Menu_Kiri {
          ...
          <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr valign="top">
              <td width="30%" height="825" bgcolor="#0B78B3"><table width="100%" border="0" cellpadding="0" cellspacing="5" bgcolor="#0B78B3">
                ...
                <tr>
                  <td colspan="2"><div align="center">
                    <form id="form1" name="form1" method="post" action="cari.php">
                      ...
                      <input type="submit" name="tmbcari" id="tmbcari" value="Cari" />
                    </form>
                  </div></td>
                  </tr>
                <tr>
                ...
                <tr>
                  <td><div align="center"><img src="Gambar/Suara.gif" width="30" height="30" /></div></td>
                  <td class="Teks_Menu_Kiri">Suara  Pelanggan</td>
                </tr>
                <tr>
                  <td colspan="2" valign="top" class="Suara_Pelanggan" align = "center">
		<marquee direction="up" height="204" width="130" scrollamount="1" scrolldelay="60" onMouseOut="this.start()" onMouseOver="this.stop()">
		<p class="general" align="justify"><span class="small"><?php
require("config.php");
$cek="Select * from buku_tamu order by id desc";
$hasil=mysql_query($cek);
while($data=mysql_fetch_array($hasil)){
echo "<br><br>
<font face=Tahoma size=\"1\" size=\"2\" color=\"blue\"><b>$data[nama]</font><br></b>
<font face=Tahoma size=\"1\" size=\"2\">$data[pesan]</font>";
} 
?></p>
		</marquee>                  </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="Teks_Menu_Kiri">Customer Service</td>
                </tr>
                <tr>
              ...
              <td width="70%"><p><? require("home.php") ?></p>
      </td>
            </tr>
          </table></td>
        </tr>
