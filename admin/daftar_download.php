...
<table width="100%" border="0">
  <tr>
    <td width="50%" height="24" bgcolor="#0B78B3"><div align="center"><span class="style15">Isi Data File Download </span></div></td>
  </tr>
  <tr>
    <td width="50%" valign="top"><form id="form1" name="form1" method="post" action="input_download.php">
      <table width="100%" border="0">
        <tr>
          <td width="38%" align="left" valign="top"><span class="style35">Judul atau Nama File </span></td>
        ...
        <tr>
          <td align="left" valign="top"><span class="style35">Nama file </span></td>
        ...
        <tr>
            <td width="50%" bgcolor="#0B78B3"><div align="center"><span class="style15">Data File Download </span></div></td>
            </tr>
    </td>
    <td width="50%" align="left" valign="top"><table width="100%" border="1" cellpadding="2" cellspacing="0">
      <tr>
        ...
        <td width="76%" bgcolor="#999999"><div align="center" class="style5">Judul atau Nama File </div></td>
...
<td>$data[judul]</td>
<td><div align=\"center\"><a href=\"delete_link_download.php?id=$data[id]\">Delete</a></div></td>
</tr>");
} 
?>
    </table></td>
