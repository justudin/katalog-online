  ...
  <table width="800" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="309"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
            <tr valign="top">
              <td width="30%" height="326" bgcolor="#0B78B3"><table width="99%" border="0" cellspacing="5" cellpadding="5">
                <tr>
                  <th scope="col"><img src="Gambar/Login.png" width="105" height="123" /></th>
                </tr>
                <tr>
                  <th scope="col"><? require("../tanggal.php") ?></th>
                </tr>
              </table></td>
              <td width="70%"><p><? require("login.php") ?></p>
                </td>
              </tr>
            </table></td>
        </tr>
